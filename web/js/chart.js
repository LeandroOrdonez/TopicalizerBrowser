...
//                console.log(terms(d));
        ...
        $("#operation-doc").append((operationDoc!=='' && operationDoc!==null)? '<span class="operation-doc">' + operationDoc.length > 150 ? operationDoc : operationDoc.substring(0,147) + '[...]' + '</span>' : '<span class="operation-doc">No documentation Available</span>');
